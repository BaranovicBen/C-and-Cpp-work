...
// Rekurzívne vyhľadať všetky potrebné funkcie.
// Určiť nové offsety vo výslednom súbore.
// Skopírovať funkcie do výstupu.
// Prepísať odkazy v kóde cez nové adresy.
// Zapísať výstupný súbor.